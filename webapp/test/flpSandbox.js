		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Examen",
									"targetURL": "#ejercicioexamen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ejercicioexamen-display": {
								"semanticObject": "ejercicioexamen",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ejercicio.examen",
									"url": sap.ui.require.toUrl("ejercicio/examen")
								}
							}
						}
					}
